...
<script src="{{ secure_url('adminlte/js') }}/bootstrap.min.js"></script>
<script src="{{ secure_url('adminlte/js') }}/select2.full.min.js"></script>
<script src="{{ secure_url('adminlte/js') }}/main.js"></script>

<script src="{{ secure_url('adminlte/plugins/slimScroll/jquery.slimscroll.min.js') }}"></script>
<script src="{{ secure_url('adminlte/plugins/fastclick/fastclick.js') }}"></script>
<script src="{{ secure_url('adminlte/js/app.min.js') }}"></script>
<script>
